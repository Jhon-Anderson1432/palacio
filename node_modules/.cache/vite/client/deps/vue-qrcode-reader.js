...
import { defineComponent as Wt, ref as we, watch as We, onMounted as vo, onUnmounted as yo, computed as Ft, createElementBlock as Lt, openBlock as jt, createElementVNode as at, withDirectives as go, normalizeStyle as wo, vShow as bo, renderSlot as Mr, withModifiers as ot } from "vue";
var Ar = (r, o, i) => {
  if (!o.has(r))
...
var Ui = Wt({
  ...
  setup(r, { emit: o }) {
    ...
    return (g, b) => (jt(), Lt("div", {
      ...
      onDragenter: b[0] || (b[0] = ot((p) => h(true), ["prevent", "stop"])),
      onDragleave: b[1] || (b[1] = ot((p) => h(false), ["prevent", "stop"])),
