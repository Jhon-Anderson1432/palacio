...
function getImageSettings(cells, size, margin, imageSettings) {
  ...
  return { x, y, h: h2, w, borderRadius };
}
...
var QrcodeSvg = defineComponent({
  ...
  setup: function(props, ctx) {
    ...
    var getSvgDataURL = function(svg) {
      return "data:image/svg+xml;charset=utf-8," + encodeURIComponent('<?xml version="1.0" standalone="no"?>' + new XMLSerializer().serializeToString(svg));
    };
    ctx.expose({
      toDataURL: function() {
        var svg = svgEl.value;
  ...
  setup: function(props, ctx) {
    ...
    ctx.expose({
      toDataURL: function(type, quality) {
        var _a2;
        return (_a2 = canvasEl.value) === null || _a2 === void 0 ? void 0 : _a2.toDataURL(type, quality);
      },
      download: function(filename) {
        if (filename === void 0) {
          filename = "qrcode.png";
...
var QrcodeVue = defineComponent({
  ...
  setup: function(props, ctx) {
    ...
    ctx.expose({
      toDataURL: function(type, quality) {
        var _a, _b;
        return (_b = (_a = childRef.value) === null || _a === void 0 ? void 0 : _a.toDataURL) === null || _b === void 0 ? void 0 : _b.call(_a, type, quality);
      },
      download: function(filename) {
        var _a, _b;
        return (_b = (_a = childRef.value) === null || _a === void 0 ? void 0 : _a.download) === null || _b === void 0 ? void 0 : _b.call(_a, filename);
      }
    });
    return function() {
